...
$env:BDSLIB='C:\Program Files (x86)\Embarcadero\Studio\22.0\Lib'
...
$env:FrameworkSDKDir=''
$env:PATH="${env:FrameworkDir};${env:FrameworkSDKDir};C:\Program Files (x86)\Embarcadero\Studio\22.0\bin;C:\Program Files (x86)\Embarcadero\Studio\22.0\bin64;C:\Program Files (x86)\Embarcadero\Studio\22.0\cmake;${env:PATH}"
$env:LANGDIR='EN'
$env:PLATFORM=''
$env:PlatformSDK=''